...
public class ErrorPageConfig implements ErrorPageRegistrar {
    ...
    public void registerErrorPages(ErrorPageRegistry registry) {
        ErrorPage error401 = new ErrorPage(HttpStatus.FORBIDDEN, "/admin/login");//todo
        //错误类型为404，找不到网页的，默认显示404.html网页
        ErrorPage error404 = new ErrorPage(HttpStatus.NOT_FOUND, "/error/404");//todo
        //错误类型为500，表示服务器响应错误，默认显示500.html网页
        ErrorPage error500 = new ErrorPage(HttpStatus.INTERNAL_SERVER_ERROR, "/error/500");
        //错误类型为500，表示服务器响应错误，默认显示500.html网页
        ErrorPage error403 = new ErrorPage(HttpStatus.FORBIDDEN, "/error/403");//todo
